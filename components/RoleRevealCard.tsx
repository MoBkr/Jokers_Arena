...
const roleMessages: Record<Role, string[]> = {
  ...
  "إنت العقل اللي بينظم الحروف… وكلمتك بتصنع تأثير حقيقي ✍️🔥"
],

'Leader of Video Makers': [
  "عينك بتشوف اللقطة الصح قبل ما تتصور… قيادتك بتصنع فرق واضح 🎬🚀"
],

'Leader of Graphic Designers': [
  "ذوقك هو البوصلة… وكل تصميم تحت إشرافك بيطلع تحفة فنية 🎨✨"
],
};
